...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const steps = document.querySelectorAll('.form-step-uni');
    let currentStep = 0;
    ...
    document.querySelectorAll('.next-btn-uni').forEach(btn => {
    ...
    document.querySelectorAll('.prev-btn-uni').forEach(btn => {
        btn.addEventListener('click', () => {
            if(currentStep > 0){
                currentStep--;
                showStep(currentStep);
...
successMsg.innerHTML = "✅ <strong>Message Sent Successfully!</strong> We'll get back to you soon.";
